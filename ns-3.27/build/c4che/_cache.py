...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Werror', '-std=c++0x', '-pthread', '-I/usr/include/python2.7', '-std=c++11', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXFLAGS = ['-std=c++0x', '-pthread', '-I/usr/include/python2.7', '-std=c++11']
...
EXAMPLE_DIRECTORIES = ['traffic-control', 'ipv6', 'wireless', 'routing', 'udp', 'tcp', 'udp-client-server', 'socket', 'tutorial', 'error-model', 'naming', 'matrix-topology', 'energy', 'stats', 'realtime']
...
NS3_EXECUTABLE_PATH = ['/home/samurdhilbk/simulations/ns-allinone-3.27_new/ns-3.27/build/src/fd-net-device', '/home/samurdhilbk/simulations/ns-allinone-3.27_new/ns-3.27/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/samurdhilbk/simulations/ns-allinone-3.27_new/ns-3.27/build']
...
cfg_files = ['/home/samurdhilbk/simulations/ns-allinone-3.27_new/ns-3.27/build/ns3/config-store-config.h', '/home/samurdhilbk/simulations/ns-allinone-3.27_new/ns-3.27/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
