...
public:
  ...
  void addToBlacklist(Mac48Address);
  bool isBlacklisted(Mac48Address);
  void clearBlacklist();
  void removeFromBlacklist(Mac48Address);
...
private:
  ...
  TracedCallback<Mac48Address> m_probeRequestLogger;   // probe request logger
  ...
  std::vector<Mac48Address> authorisedSTA;
  std::map<Mac48Address, bool> m_blacklistSTA;
};
