...
public:
  ...
  void  ReportReTxData(Mac48Address address, Ptr<const Packet> packet);
...
private:
  ...
  /**
     * The trace source fired when the retransmission of a data packet is required
  */
  TracedCallback< Mac48Address,Ptr<const Packet> > m_macReTxDataRequired;
};
